...
description: Étudier la concurrence pour le cours MVP à la HEIG-VD, Suisse
url: https://heig-vd-mvp-course.github.io/heig-vd-mvp-course/01-contenus-du-cours/06-etudier-la-concurrence/presentation.html
header: "[**Étudier la concurrence**][contenu-complet-sur-github]"
footer:
...
- Identifier les forces, les faiblesses, les opportunités et les menaces liées à
  la concurrence.
...
> La concurrence est constituée des entreprises à qui votre clientèle ne donne
> pas d'argent parce qu'elle achète chez vous ! En d'autres termes, la
...
- Leurs messages marketing avec leur public cible.
- Leur rapport annuel.
- Le nombre de personnes salariées, leur management, chiffre d'affaires et parts
  de marché.
- Leur clientèle et leur façon de segmenter le marché.
...
[contenu-complet-sur-github]:
	https://github.com/heig-vd-mvp-course/heig-vd-mvp-course/blob/main/01-contenus-du-cours/06-etudier-la-concurrence/README.md
[license]:
