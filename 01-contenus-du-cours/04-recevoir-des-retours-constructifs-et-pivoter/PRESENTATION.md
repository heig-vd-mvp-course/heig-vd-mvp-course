...
description:
  Recevoir des retours constructifs et pivoter pour le cours MVP à la HEIG-VD,
  Suisse
...
- Avoir conscience des biais d'investissement (_"sunk cost fallacy"_).
- **Ce n'est pas grave.**
...
## Identifier les forces et faiblesses des éléments pour pivoter (1/2)
...
## Identifier les forces et faiblesses des éléments pour pivoter (2/2)

- Forces (_"strengths"_).
- Faiblesses (_"weaknesses"_).
- Opportunités (_"opportunities"_).
- Menaces (_"threats"_).

![bg right:40% contain](https://upload.wikimedia.org/wikipedia/commons/0/0b/SWOT_en.svg)
...
La méthodologie MVP décrite dans le support de cours peut vous aider.
