...
description: Trouver des idées originales pour le cours MVP à la HEIG-VD, Suisse
url: https://heig-vd-mvp-course.github.io/heig-vd-mvp-course/01-contenus-du-cours/05-trouver-des-idees-originales/presentation.html
header: '[**Trouver des idées originales**][contenu-complet-sur-github]'
footer:
