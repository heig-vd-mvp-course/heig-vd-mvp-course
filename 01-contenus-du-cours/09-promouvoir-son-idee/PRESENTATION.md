...
description: Promouvoir son idée pour le cours MVP à la HEIG-VD, Suisse
url: https://heig-vd-mvp-course.github.io/heig-vd-mvp-course/01-contenus-du-cours/09-promouvoir-son-idee/presentation.html
header: "[**Promouvoir son idée**][contenu-complet-sur-github]"
footer:
...
## Qu'est-ce que la promotion d'une idée ? (1/2)

- Ensemble des actions et des stratégies mises en place pour faire connaître une
  idée.
- Adapté à un public cible.
- But : susciter l'intérêt/convaincre et encourager à adopter ou soutenir
  l'idée.

![bg right:40%][illustration-principale]

## Qu'est-ce que la promotion d'une idée ? (2/2)

Différentes techniques :

- Le pitch.
- Avoir une présence en ligne (site web, réseaux sociaux, etc.).
...
- Être clair.e et concis.e.
- Créer de l'émotion.
- Être authentique.
- Utiliser les bons canaux.
- Être persévérant.e.

**S'apparente beaucoup au pitch !**

![bg right:40%][illustration-principale]

## _"Mais si je parle de mon idée à tout le monde, elle va être copiée !"_

Garder une idée secrète peut sembler être une bonne stratégie pour éviter la
concurrence, mais cela peut aussi limiter les opportunités de feedback, de
collaboration et de validation de l'idée.

En général, il est préférable de partager son idée avec un public cible pour
obtenir des retours constructifs, améliorer l'idée et créer une communauté de
soutien autour de celle-ci.

Il y a une différence entre avoir une idée et la concrétiser.

## Créer une landing page efficace pour votre MVP

- Une manière efficace de promouvoir son idée est de créer une landing page
  dédiée à votre MVP.
- Un formulaire de contact peut être ajouté pour collecter des retours et des
  données utilisateurs.

![bg right:40%][illustration-creer-une-landing-page-efficace-pour-votre-mvp]
...
- Il existe des templates et des services pour ça.
...
- "Vibe coder" votre landing page (prototype rapide) est option.
...
<!-- Parler de l'exemple du Patator (je (Ludovic) me souviens plus de cette anecdote) -->

#### Hébergement d'une landing page

Solutions pratiques d'hébergement rapide (entre pleins d'autres):
...
- Si votre landing page est publique, elle sera automatiquement indexée par les
  moteurs de recherche.
- Vous pouvez accélérer le processus en soumettant votre page à Google Search
  Console.
...
- [Illustration principale][illustration-principale] par
  [Nima Mohammadi](https://unsplash.com/@nimapcart) sur
  [Unsplash](https://unsplash.com/photos/a-street-light-with-a-bunch-of-lights-on-top-of-it-qy6kOn9Q0JU)
- [Illustration][illustration-objectifs] par
  [Aline de Nadai](https://unsplash.com/@alinedenadai) sur
  [Unsplash](https://unsplash.com/photos/j6brni7fpvs)
- [Illustration][illustration-creer-une-landing-page-efficace-pour-votre-mvp]
  par [Noah Näf](https://unsplash.com/@noahdavis) sur
  [Unsplash](https://unsplash.com/photos/person-doing-paragliding-during-daytime-5_uyJOrTZmc)
...
[contenu-complet-sur-github]:
	https://github.com/heig-vd-mvp-course/heig-vd-mvp-course/blob/main/01-contenus-du-cours/09-promouvoir-son-idee/README.md
[license]:
...
[illustration-principale]:
	https://images.unsplash.com/photo-1711734342461-bd1a393a12ff?fit=crop&h=720
[illustration-objectifs]:
	https://images.unsplash.com/photo-1516389573391-5620a0263801?fit=crop&h=720
[illustration-creer-une-landing-page-efficace-pour-votre-mvp]:
	https://images.unsplash.com/photo-1562583078-9a9e329f2185?fit=crop&h=720
