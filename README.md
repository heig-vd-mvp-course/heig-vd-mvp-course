# Cours MVP de la HEIG-VD [![License](https://img.shields.io/github/license/heig-vd-mvp-course/heig-vd-mvp-course)](./LICENSE.md)

Voici le dépôt du cours
[Lancez votre MVP](https://gaps.heig-vd.ch/consultation/fiches/uv/uv.php?id=7379)
de la [HEIG-VD](https://heig-vd.ch) en Suisse !

## Calendrier du cours et syllabus
...
| Contenus                                            | Slide                | Stratégies d’enseignement    | Objectifs                                     | Méthodes d’évaluation |
| --------------------------------------------------- | -------------------- | ---------------------------- | --------------------------------------------- | --------------------- |
| Introduction, motivation et organisation de l'unité | :yes: web / :no: pdf | Cours magistral, Discussions | Lister les objectifs du cours et les attentes | -                     |
...
<https://github.com/orgs/heig-vd-mvp-course/discussions>.
...
- a) L’exposé/cours magistral
- b) La discussion plénière
- c) Le jeu de rôle
- d) La présentation par des étudiant-e-s
- e) La série d’exercices ou de cas
- f) L’apprentissage par problèmes
- g) Le stage de terrain
- h) La discussion en sous-groupe
- i) L’atelier pratique (p. ex. labo)
- j) Le projet individuel
- k) Le projet de groupe
- l) Les travaux dirigés
- m) Le tutorat par les pairs
- n) La simulation
